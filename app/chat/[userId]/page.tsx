...
export default function ChatConversationPage() {
          ...
          <div className="min-h-screen bg-gradient-to-br from-pink-100 to-red-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
            <div className="text-center max-w-md mx-auto p-8">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                El usuario que buscas no existe o no puede iniciar el chat que deseas
              </p>
              <button
    ...
    return (
        <div className="h-screen bg-gradient-to-br from-pink-100 to-red-100 dark:from-gray-900 dark:form-gray-800">
